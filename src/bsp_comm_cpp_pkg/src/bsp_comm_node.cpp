...
#include "uvms3_test/msg/hal_inertialnavi.hpp"
#include "uvms3_test/msg/hal_dvl.hpp"
#include "uvms3_test/msg/hal_depthsensor.hpp"
#include "uvms3_test/msg/hal_mainthruster.hpp"
#include "uvms3_test/msg/hal_auxithruster.hpp"
#include "uvms3_test/msg/hal_battery.hpp"
#include "uvms3_test/msg/hal_tailservo.hpp"
#include "uvms3_test/msg/hal_armmotor.hpp"
#include "uvms3_test/msg/hal_antenna.hpp"
...
private:
    ...
    // ================= 回调函数 =================
    void inertial_callback(const uvms3_test::msg::HalInertialnavi::SharedPtr msg)
    {
        if (!active_) return;
        inertial_data_ = *msg;
    }
    
    void dvl_callback(const uvms3_test::msg::HalDvl::SharedPtr msg)
    {
        if (!active_) return;
        dvl_data_ = *msg;
    }
    
    void depthsensor_callback(const uvms3_test::msg::HalDepthsensor::SharedPtr msg)
    {
        if (!active_) return;
        depthsensor_data_ = *msg;
    }
    
    void mainthruster_callback(const uvms3_test::msg::HalMainthruster::SharedPtr msg)
    {
        if (!active_) return;
        mainthruster_data_ = *msg;
    }
    
    void auxithruster_callback(const uvms3_test::msg::HalAuxithruster::SharedPtr msg)
    {
        if (!active_) return;
        auxithruster_data_ = *msg;
    }
    
    void battery_callback(const uvms3_test::msg::HalBattery::SharedPtr msg)
    {
        if (!active_) return;
        battery_data_ = *msg;
    }
    
    void tailservo_callback(const uvms3_test::msg::HalTailservo::SharedPtr msg)
    {
        if (!active_) return;
        tailservo_data_ = *msg;
    }
    
    void armmotor_callback(const uvms3_test::msg::HalArmmotor::SharedPtr msg)
    {
        if (!active_) return;
        armmotor_data_ = *msg;
    }
    
    void antenna_callback(const uvms3_test::msg::HalAntenna::SharedPtr msg)
    {
        if (!active_) return;
        antenna_data_ = *msg;
    }
...
// ================= 打包函数 =================
    std::vector<uint8_t> pack_inertial(const uvms3_test::msg::HalInertialnavi & msg)
    {
    ...
    std::vector<uint8_t> pack_dvl(const uvms3_test::msg::HalDvl & msg)
    {
    ...
    std::vector<uint8_t> pack_depthsensor(const uvms3_test::msg::HalDepthsensor & msg)
    {
    ...
    std::vector<uint8_t> pack_mainthruster(const uvms3_test::msg::HalMainthruster & msg)
    {
    ...
    std::vector<uint8_t> pack_auxithruster(const uvms3_test::msg::HalAuxithruster & msg)
    {
    ...
    std::vector<uint8_t> pack_battery(const uvms3_test::msg::HalBattery & msg)
    {
    ...
    std::vector<uint8_t> pack_tailservo(const uvms3_test::msg::HalTailservo & msg)
    {
    ...
    std::vector<uint8_t> pack_armmotor(const uvms3_test::msg::HalArmmotor & msg)
    {
    ...
    std::vector<uint8_t> pack_antenna(const uvms3_test::msg::HalAntenna & msg)
    {
...
// ================= 打印函数 =================
    void print_inertial(const uvms3_test::msg::HalInertialnavi & msg)
    {
    ...
    void print_dvl(const uvms3_test::msg::HalDvl & msg)
    {
    ...
    void print_depthsensor(const uvms3_test::msg::HalDepthsensor & msg)
    {
    ...
    void print_mainthruster(const uvms3_test::msg::HalMainthruster & msg)
    {
    ...
    void print_auxithruster(const uvms3_test::msg::HalAuxithruster & msg)
    {
    ...
    void print_battery(const uvms3_test::msg::HalBattery & msg)
    {
    ...
    void print_tailservo(const uvms3_test::msg::HalTailservo & msg)
    {
    ...
    void print_armmotor(const uvms3_test::msg::HalArmmotor & msg)
    {
    RCLCPP_INFO(this->get_logger(), "timestamp: %ld", msg.timestamp);
    ...
    void print_antenna(const uvms3_test::msg::HalAntenna & msg)
    {
...
private:
    ...
    void light_control(const std::vector<uint8_t>& payload)
    {
        ...
        uvms3_test::msg::HalLightControl msg;
    ...
    void antenna_control(const std::vector<uint8_t>& payload)
    {
        ...
        // 构造ROS消息
        uvms3_test::msg::HalAntennaControl msg;
    ...
    void battery_control(const std::vector<uint8_t>& payload)
    {
        ...
        auto request = std::make_shared<uvms3_test::srv::HalBatteryControl::Request>();
        request->cmd = cmd;

        battery_control_client_->async_send_request(request, [this, cmd](rclcpp::Client<uvms3_test::srv::HalBatteryControl>::SharedFuture future)
            {
                try {
